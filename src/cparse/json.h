 ...
 * @file
 * @header cParse JSON
 * Functions for dealing with json in the library.
 */
 ...
 * @return the allocated json object or NULL
 */
 ...
 * @return the object with an incremented reference count
 */
 ...
 */
cParseJson *cparse_json_new_number(cParseNumber number);

/*!
 * creates a floating point number as a json object
 * @param number the floating point number
 * @return the floating point number as a json object
 */
cParseJson *cparse_json_new_real(double number);
 ...
 * @param obj the json object instance
 * @param key the key identifying the attribute
 * @return the number of zero if no conversion
 */
 ...
 * @param obj the json object instance
 * @param key the key identifying the attribute
 * @return the floating point or 0.0
 */
 ...
 * @return a json type of #cParseJSONType
 */
 ...
 * @return a json object or NULL if str was not valid json
 */
 ...
 */
void cparse_json_array_add(cParseJson *array, cParseJson *value);
 ...
 * @return the number value or zero if no conversion
 */
 ...
 * @param index the position in the array
 * @param def the default value if non-existent
 * @return the floating point value or zero if no conversion
 */
 ...
 * @param array the array instance
 * @param index the position in the array
 * @return the string value or zero if no conversion
 */
 ...
 * @param obj the json object instance
 * @return the number value or zero
 */
cParseNumber cparse_json_to_number(cParseJson *obj);

/*! gets the floating point value of an object. if no conversion possible errno is set to EINVAL
 * @param obj the json object instance
 * @return the floating point value or zero
 */
double cparse_json_to_real(cParseJson *obj);

/*! gets the boolean value of an object.
 * @param obj the json object instance
 * @return the boolean value or zero
 */
bool cparse_json_to_bool(cParseJson *obj);

/*! gets the string value of an object.
 * @param obj the json object instance
 * @return the string value or zero
 */
const char *cparse_json_to_string(cParseJson *obj);
 ...
 */
#define cparse_json_foreach_start(obj, key, val)                                                                  \
    do {                                                                                                          \
        char *key;                                                                                                \
...
#define cparse_json_foreach_end \
    }                           \
    while (0)
